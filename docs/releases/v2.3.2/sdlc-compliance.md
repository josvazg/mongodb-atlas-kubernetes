SSDLC Compliance Report: Atlas Kubernetes Operator Manager v2.3.2
=================================================================
...
- **Product and Release Name**
    ...
    - Atlas Kubernetes Operator v2.3.2, 2024-06-10.
...
- **Release Signature Report**
  ...
  - Self-verification shortcut:
    ```shell
    make verify IMG=mongodb/mongodb-atlas-kubernetes-operator:2.3.2 SIGNATURE_REPO=mongodb/signatures
    ```
