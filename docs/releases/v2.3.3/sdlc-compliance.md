SSDLC Compliance Report: Atlas Kubernetes Operator Manager v2.3.3
=================================================================
...
- **Product and Release Name**
    ...
    - Atlas Kubernetes Operator v2.3.3, 2024-06-10.
...
- **Release Signature Report**
  ...
  - Self-verification shortcut:
    ```shell
    make verify IMG=mongodb/mongodb-atlas-kubernetes-operator:2.3.3 SIGNATURE_REPO=mongodb/signatures
    ```
