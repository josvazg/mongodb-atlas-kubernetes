...
func RegisterAll(ctx context.Context, mgr manager.Manager, logger *zap.Logger) error {
	...
	return Register(ctx, mgr,
		...
		NewLocalCredentialsIndexer(AtlasDatabaseUserCredentialsIndex, &akov2.AtlasPrivateEndpoint{}, logger),
		NewLocalCredentialsIndexer(AtlasPrivateEndpointCredentialsIndex, &akov2.AtlasPrivateEndpoint{}, logger),
	)
}
